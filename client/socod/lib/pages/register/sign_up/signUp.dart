      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            reusableText("Select your gender",color: AppColors.primaryThreeElementText),
            SizedBox(height: 5.h),
            GenderButton("Male",
            (value){
            ...
            reusableText("Gender of interest",color: AppColors.primaryThreeElementText),
            SizedBox(height: 5.h),
            GenderButton("Female",
            (value){
            ...
            reusableText("Interest",color: AppColors.primaryThreeElementText),
            SizedBox(height: 5.h),
            BuildTextField("Your Hobbies", 'hobbies', "star",
            (value) {
